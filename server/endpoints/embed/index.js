  ...
  app.post(
    ...
    async (request, response) => {
      try {
        ...
        console.log("CHAT REQUEST RECEIVED", { embedId: request.params.embedId, sessionId, message });
        console.log("Full Body:", body);
 
        console.log("Public Stream Chat Request:", {
          embedUuid: embed?.uuid,
          workspace: embed?.workspace?.name,
          sessionId,
        ...
        console.log("STARTING STREAM for Embed", embed.uuid);

          ...
          switch (label) {
            ...
            case "meta_page_favicon":
              requestedSettings[label] =
                await SystemSettings.getValueOrFallback({ label }, null);
              break;
            case "seetech_chat_heading":
            case "seetech_chat_subtitle":
            case "seetech_chat_suggested_prompts":
            case "seetech_chat_placeholder":
            case "seetech_welcome_message":
            case "seetech_primary_color":
            case "seetech_bg_primary":
            case "seetech_typography":
              requestedSettings[label] =
                await SystemSettings.getValueOrFallback({ label }, null);
              break;

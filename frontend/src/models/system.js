...
const System = {
  ...
  getBrandingConfig: async () => {
    return await fetch(`${API_BASE}/system/branding-config`, {
      method: "GET",
      headers: baseHeaders(),
    })
      .then((res) => res.json())
  ...
  updateBrandingConfig: async (config) => {
    return await fetch(`${API_BASE}/system/branding-config`, {
      method: "POST",
      headers: baseHeaders(),
  ...
  testLLM: async (data) => {
    return await fetch(`${API_BASE}/system/test-llm`, {
      method: "POST",
      headers: baseHeaders(),
      body: JSON.stringify(data),
    })
  ...
  getLLMConfigs: async () => {
    return await fetch(`${API_BASE}/system/llm-configs`, {
      headers: baseHeaders(),
    })
      .then((res) => res.json())
      .catch((e) => {
  ...
  addLLMConfig: async (data) => {
    return await fetch(`${API_BASE}/system/llm-configs/add`, {
      method: "POST",
      headers: baseHeaders(),
      body: JSON.stringify(data),
    })
  ...
  toggleLLMConfig: async (id) => {
    return await fetch(`${API_BASE}/system/llm-configs/${id}/toggle`, {
      method: "POST",
      headers: baseHeaders(),
    })
      .then((res) => res.json())
  ...
  deleteLLMConfig: async (id) => {
    return await fetch(`${API_BASE}/system/llm-configs/${id}`, {
      method: "DELETE",
      headers: baseHeaders(),
    })
      .then((res) => res.json())
  ...
  getPublicEmbedId: async function () {
    return await fetch(`${API_BASE}/setup-complete`)
      .then((res) => res.json())
      .then((res) => res?.results?.seetech_public_embed_uuid || null)
      .catch(() => null);
  },
};

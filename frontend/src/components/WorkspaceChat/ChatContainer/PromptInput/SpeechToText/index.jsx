...
export default function SpeechToText({ sendCommand }) {
  ...
  return (
    <div
      ...
      className={`group border-none relative flex justify-center items-center cursor-pointer w-8 h-8 rounded-xl transition-all duration-300 ${
        listening ? "bg-red-500 shadow-red-500/20" : "hover:bg-white/10 light:hover:bg-black/5"
      }`}
    >
      <Microphone
        weight="regular"
        size={18}
        className={`pointer-events-none transition-colors shrink-0 ${
          listening

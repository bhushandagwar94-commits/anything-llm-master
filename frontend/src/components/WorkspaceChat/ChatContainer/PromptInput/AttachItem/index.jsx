    ...
    <>
      ...
      >
        <div className="relative flex items-center justify-center">
          <Plus
            size={12}
            className="pointer-events-none text-white/40 light:text-[#475569] group-hover:text-white light:group-hover:text-[#0F172A] transition-colors shrink-0"
            weight="bold"
          />
          {files.length > 0 && (
            <div className="absolute -top-2 -right-2 bg-green-500 text-white text-[9px] font-bold rounded-full w-3.5 h-3.5 flex items-center justify-center shadow-lg shadow-green-500/20">
              {files.length}
            </div>
          )}
        </div>

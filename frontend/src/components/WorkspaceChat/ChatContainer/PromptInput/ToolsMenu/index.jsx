...
function TabButton({ active, onClick, children }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`border-none cursor-pointer hover:bg-zinc-700/50 light:hover:bg-slate-50 px-1.5 py-0.5 rounded text-[10px] font-medium text-center whitespace-nowrap transition-colors ${
        active
          ? "bg-zinc-700 text-white light:bg-[#EFF6FF] light:text-[#2563EB]"
          : "text-zinc-400 light:text-[#64748B]"
      }`}
    >
      {children}
    </button>

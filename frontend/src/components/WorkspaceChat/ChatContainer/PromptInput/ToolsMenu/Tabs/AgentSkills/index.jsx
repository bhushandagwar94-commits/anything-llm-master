  ...
  return (
    <div className="relative shrink-0">
      ...
      <input
        ...
        className="w-full pl-7 pr-2 py-1 text-xs bg-zinc-700/50 light:bg-slate-50 border border-zinc-600 light:border-slate-200 rounded text-white light:text-[#0F172A] placeholder:text-zinc-500 light:placeholder:text-[#64748B] outline-none focus:border-zinc-500 light:focus:border-[#2563EB]/50 transition-all"
      />
    </div>
  );
}

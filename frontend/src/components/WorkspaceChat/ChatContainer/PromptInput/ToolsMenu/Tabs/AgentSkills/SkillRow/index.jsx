...
export default function SkillRow({
  ...
  if (highlighted) classNames += " bg-zinc-700/50 light:bg-[#EFF6FF]";
  else classNames += " hover:bg-zinc-700/30 light:hover:bg-slate-50";
  ...
  return (
    ...
    >
      <span className="text-xs text-white light:text-[#1E293B] font-medium">{name}</span>

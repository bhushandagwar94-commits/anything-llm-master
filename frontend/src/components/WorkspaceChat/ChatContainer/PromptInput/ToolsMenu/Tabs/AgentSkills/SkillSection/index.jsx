...
export default function SkillSection({
  ...
  if (highlighted) headerClasses += " bg-zinc-700/50 light:bg-[#EFF6FF]";
    ...
    <div className={indented ? "ml-3" : ""}>
      ...
      >
        <div className="flex items-center gap-1.5">
          ...
          />
          <span className="text-[10px] font-semibold uppercase tracking-wide text-zinc-400 light:text-[#64748B]">
            {name}
          </span>
          {isMcp && (
            <span className="text-[8px] px-1 py-px rounded bg-zinc-600/50 light:bg-[#EFF6FF] text-zinc-300 light:text-[#2563EB] font-bold leading-tight">
              MCP
            </span>
          )}
        </div>

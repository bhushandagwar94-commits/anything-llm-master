                      ...
                      <div className="flex gap-x-2 items-center justify-between">
                        <Link
                          ...
                          className={`
                            ...
                            ${isActive ? "light:bg-[#EFF6FF] font-bold" : "hover:bg-theme-sidebar-subitem-hover light:hover:bg-slate-50"}
                          `}
                        >
                          <div className="flex flex-row justify-between w-full items-center">
                            ...
                            >
                              <DotsSixVertical
                                size={20}
                                className={`${isActive ? "text-blue-500 light:text-blue-600" : "text-zinc-500 light:text-slate-400"}`}
                                weight="bold"
                              />
                            </div>
                            <div
                            ...
                            >
                              <div className="w-[130px] overflow-hidden">
                                <p
                                  ...
                                  ${isActive ? "font-bold text-white light:text-blue-700" : "font-medium text-theme-text-primary"} truncate
                            ...
                            {user?.role !== "default" && (
                              ...
                              >
                                ...
                                >
                                  <UploadSimple
                                    className={`h-[20px] w-[20px] ${isActive ? "text-zinc-400 hover:text-white light:text-blue-600 light:group-hover/upload:text-blue-700" : "text-zinc-400 hover:text-white light:text-slate-400 light:group-hover/upload:text-slate-600"}`}
                                  />
                                </button>
                                <button
                                  onClick={(e) => {
                                ...
                                >
                                  <GearSix
                                    ...
                                    className={`h-[20px] w-[20px] ${isActive ? "text-zinc-400 hover:text-white light:text-blue-600 light:group-hover/gear:text-blue-700" : "text-zinc-400 hover:text-white light:text-slate-400 light:group-hover/gear:text-slate-600"}`}
                                  />
                                </button>
                              </div>
                            )}

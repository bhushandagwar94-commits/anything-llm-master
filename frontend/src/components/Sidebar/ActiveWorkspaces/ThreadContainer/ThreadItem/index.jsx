  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`${
          isActive
            ? "border-l-2 border-b-2 border-white light:border-blue-500 z-[2]"
            : "border-l border-b border-zinc-500 light:border-slate-300 z-[1]"
        ...
        <div
          ...
          className={`${
            idx <= activeIdx && !isActive
              ? "border-l-2 border-white light:border-blue-500 z-[2]"
              : "border-l border-zinc-500 light:border-slate-300 z-[1]"
      ...
      />
      <div
        className={`flex w-full items-center justify-between pr-2 group relative ${isActive ? "bg-[var(--theme-sidebar-thread-selected)] light:bg-[#EFF6FF]" : "hover:bg-theme-sidebar-subitem-hover light:hover:bg-slate-50"} rounded-[4px]`}
      >
        {thread.deleted ? (
          ...
          >
            <p
              className={`text-left text-sm truncate max-w-[150px] ${
                isActive
                  ? "font-semibold text-white light:text-blue-700"
                  : "text-theme-text-primary font-medium light:text-slate-700"
              }`}
            >
              {thread.name}
            </p>

...
import ChatWindowShell from "@/components/WorkspaceChat/ChatContainer/ChatWindowShell";
import ThemeToggle from "@/components/ThemeToggle";
import MenuCards from "@/components/SEETECH/MenuCards";
  ...
  if (workspaceLoading) {
    return (
      <div
        ...
        className="transition-all duration-500 relative md:ml-[2px] md:mr-[16px] md:my-[16px] md:rounded-[16px] bg-theme-bg-container w-full h-full overflow-hidden"
      />
    );
  }
  ...
  return (
    ...
    >
      <DnDFileUploaderWrapper>
        ...
        <div className="flex flex-col h-full w-full items-center justify-start overflow-y-auto pt-8 pb-32 px-6 no-scroll">
          <MenuCards sendCommand={(msg) => sendCommand({ text: msg, autoSubmit: true })} />
